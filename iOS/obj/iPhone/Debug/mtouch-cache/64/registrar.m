...
void xamarin_create_classes () {
	...
	__xamarin_class_map [58].handle = objc_getClass ("__MonoMac_NSActionDispatcher");
	__xamarin_class_map [59].handle = objc_getClass ("__Xamarin_NSTimerActionDispatcher");
	__xamarin_class_map [60].handle = objc_getClass ("__MonoMac_NSAsyncActionDispatcher");
	...
	__xamarin_class_map [200].handle = objc_getClass ("__UILongPressGestureRecognizer");
	__xamarin_class_map [201].handle = objc_getClass ("__UITapGestureRecognizer");
	__xamarin_class_map [202].handle = objc_getClass ("__UIPanGestureRecognizer");
